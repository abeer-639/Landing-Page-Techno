  ...
  return (
    <div className="relative w-full h-[110vh] sm:h-screen bg-[url('/images/bg.png')] bg-cover bg-center
     flex justify-center flex-col ">
        ...
        <p className="text-sm sm:text-base md:text-xl font-bold text-blue-950">Make Your Smartest Invesment</p>
         <h1 className="text-2xl md:text-3xl lg:text-4xl mt-6 mb-6 font-bold text-blue-950
          leading-[2.5rem] md:leading-[3.5rem] ">Kickstart , Scale , And Thrive Faster with  
           <span className="text-rose-700"> Techno</span> </h1>
            <p className="tetx-xs sm:text-sm md:text-base font-medium text-gray-700">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi voluptas voluptatem, 
            corrupti provident suscipit alias veritatis velit error iusto, aspernatur rerum nihil! 
            Ducimus ut eum numquam laudantium doloremque error magnam.</p>
            ...
            {/* rating  */}
                <div className="flex sm:flex-row flex-col sm:items-center sm:space-x-10 mt-6">
                    ...
                    <div className="flex sm:mt-0 items-center space-x-4">
                ...
                <a href="#_" className="relative px-10 py-3 font-medium text-white transition duration-300 bg-green-600 rounded-md hover:bg-green-800 ease">
                    <span className="absolute bottom-0 left-0 h-full -ml-2">
                        <svg viewBox="0 0 487 487" className="w-auto h-full opacity-100 object-stretch" xmlns="http://www.w3.org/2000/svg"><path d="M0 .3c67 2.1 134.1 4.3 186.3 37 52.2 32.7 89.6 95.8 112.8 150.6 23.2 54.8 32.3 101.4 61.2 149.9 28.9 48.4 77.7 98.8 126.4 149.2H0V.3z" fill="#FFF" fillRule="nonzero" fillOpacity=".1"></path></svg>
                    </span>
                    <span className="absolute top-0 right-0 w-12 h-full -mr-3">
